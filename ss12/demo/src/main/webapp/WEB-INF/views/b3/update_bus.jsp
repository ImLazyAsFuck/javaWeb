  ...
  <div class="bg-white p-6 rounded-lg shadow-md">
    <form:form modelAttribute="bus" acceptCharset="UTC-8" enctype="multipart/form-data" action="/bus/edit/${bus.id}" method="post" cssClass="space-y-4">
      ...
      <div>
        ...
        <form:input path="rowSeat" type="number" min="1" cssClass="w-full p-2 border rounded"/>
        <form:errors path="rowSeat" cssClass="text-red-500 text-sm"/>
      </div>
      <div>
        <label class="block text-sm font-medium">Columns</label>
        <form:input path="colSeat" type="number" min="1" cssClass="w-full p-2 border rounded"/>
