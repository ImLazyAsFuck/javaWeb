...
public class AppConfig implements WebMvcConfigurer{
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/ss16?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
